...
bool j1Render::Load(pugi::xml_node& node_sent) {
	camera.x = node_sent.child("camera").attribute("x").as_int();
	camera.y = node_sent.child("camera").attribute("y").as_int();
	return true;
}

// TODO 8: Create a method to save the state of the renderer
// using append_child and append_attribute
bool j1Render::Save(pugi::xml_node& node_sent) {
	pugi::xml_node cam= node_sent.append_child("camera");
