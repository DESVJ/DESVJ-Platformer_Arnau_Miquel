...
public:
	...
	void ResetViewPort();
	bool Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section = NULL, bool flip = false, fPoint speed = { 1.0f, 1.0f }, double angle = 0, int pivot_x = INT_MAX, int pivot_y = INT_MAX) const;
